...
{/*}
      no need button here
        ...
        <s.Container
          ...
          >
            <s.SpacerXSmall/>
            <StyledImgXsmallHsq alt={"example"} src={"/config/images/display4.png"}/>
            <s.SpacerXSmall/>

            <StyledImgXsmallHsq alt={"example"} src={"/config/images/display2.png"}/>
            <s.SpacerXSmall/>
          ...
          <s.SpacerXSmall/>
            ...
            <StyledImgXsmallHsq alt={"example"} src={"/config/images/display3.png"}/>
            <s.SpacerXSmall/>

            <StyledImgXsmallHsq alt={"example"} src={"/config/images/display1.png"}/>
            <s.SpacerXSmall/>
